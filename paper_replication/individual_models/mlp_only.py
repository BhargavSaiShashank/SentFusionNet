...
def run_mlp():
    print("--- 🧠 STANDALONE MLP (NEURAL NETWORK) ---")
    df = pd.read_csv(DATA_FILE, index_col='Date', parse_dates=True)
    
    # Selecting the top 10 features as per the Scenario C RFE
    ...
    # Matching the paper's double-scaling (X and y)
    ...
    # 100% Replication MLP Architecture (100, 50, 25)
    model = MLPRegressor(hidden_layer_sizes=(100, 50, 25), max_iter=2000, random_state=42)
    ...
    print(f"Results for MLP (Scenario C):")
